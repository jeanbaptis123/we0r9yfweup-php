			...
			<div class="main" id="checkoutform">
				<div style="display: flex;margin-bottom: 5px;">
					<div style="width: 50%;margin-right: 2px;">
						<p class="newuser">First Name</p>
						<input class="newuser" type="text" name="fname" placeholder="First Name" id="firstname_box" required>
					</div>
					<div style="width: 50%;margin-left: 2px;">
						<p class="newuser">Last Name</p>
						<input class="newuser" type="text" name="lname" placeholder="Last Name" id="lastname_box" required>
					</div>
				</div>
...
<div class="ph-row">
	...
	if(parsed_qs.id != null) {
		...
		document.getElementById("firstname_box").required = false;
		document.getElementById("lastname_box").required = false;
	...
	for (var key in parsed_qs) {
		let usedpars = ['key', 'id', 'row', 'tac', 'paddle', 'email', 'sessionid', 'firstname', 'lastname'];
