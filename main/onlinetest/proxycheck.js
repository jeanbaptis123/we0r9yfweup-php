...
var api_url = "https://lb.proxyscrape.com/v2/online_check.php";
...
function AddProxy(ip, port) {
    ...
    try {
        ...
        var tr = document.createElement("tr").id = ip + ":" + port;
                ...
                try {
                    ...
                    response.json().then(function(data) {
                        data.forEach(response_json => {
                            const row = document.getElementById(response_json["ip"] + ":" + response_json["port"]);
